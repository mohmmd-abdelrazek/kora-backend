...
const submitPlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { teamId, playerIndex, name, position } = req.body;
    try {
        const result = yield pgConfig_1.default.query("INSERT INTO players (team_id, player_index, name, position) VALUES ($1, $2, $3, $4) RETURNING *", [teamId, playerIndex, name, position]);
        res.status(201).json({
...
const getPlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield pgConfig_1.default.query("SELECT * FROM players WHERE team_id = $1 AND player_index = $2", [teamId, playerIndex]);
...
const updatePlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        const { rows } = yield pgConfig_1.default.query(query, values);
        if (rows.length > 0) {
...
const deletePlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { rows } = yield pgConfig_1.default.query(deleteQuery, [teamId, playerIndex]);
        if (rows.length > 0) {
